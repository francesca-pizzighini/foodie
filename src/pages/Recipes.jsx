...
function Recipes() { 
  ...
  const url = `https://api.spoonacular.com/recipes/complexxSearch?apiKey=${apiKey4}&diet=vegetarian${diet}&cuisine=${formData.cuisine}&number=12&query=${formData.query}`
